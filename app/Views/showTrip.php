...
<body style="overflow-y: hidden; margin: 0 !important;">
    ...
    <div class="d-flex" style="height: 92vh; margin-top: 8vh;">
        ...
        <div class="sidebar-content">
            ...
            <div class="ride-requests">
                ...
                <?php if (!empty($trip->rideRequests)): ?>
                    <ul>
                        <?php foreach ($trip->rideRequests as $request): ?>
                            <li>
                                <p><strong>Richiedente:</strong> <?= $request['name'] ?></p>
                                <p><strong>Posti Richiesti:</strong> <?= $request['seats'] ?></p>
                                <p><strong>Messaggio:</strong> <?= $request['message'] ?></p>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
                    <p>Nessuna richiesta di passaggio al momento.</p>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="sidebar-container">
        ...
        <button
            ...
            class="sidebarToggleBtn toggle-btn" onclick="this.parentElement.querySelector('.sidebar').classList.remove('hidden'); this.style.display = 'none';">☰
        </button>
    </div>
</body>
