...
{
    public static array $TRIP_STATUS = [
        "STARTED" => "STARTED",
        "ENDED" => "ENDED"
    ];
    ...
    public static string $TRIP_NOT_FOUND = "Viaggio non trovato!";
    public static string $TRIP_REGISTRATION_ERROR = "Errore nella creazione del viaggio!";
